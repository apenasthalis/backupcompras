...
class EmpresaSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ($empresas as $empcontad => $dados) {
            $segmentoNome = $dados['segmento'];
            unset($dados['segmento']);
            $dados['segmento_id'] = $this->segmentoId($segmentoNome);
    ...
    private function segmentoId(string $nome): int
    {
        return Segmento::firstOrCreate(['name' => $nome])->id;
    }
}
